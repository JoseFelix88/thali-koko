package com.thalisoft.vista.preventa.ordenpedido.pagos.proveedor;
...
public class FormPagosProveedor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "GESTIONAR PAGOS A PROVEEDOR", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 18), new java.awt.Color(0, 102, 204))); // NOI18N
    ...
    private void txtnumordenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtnumordenActionPerformed
        try {
            ...
            Logger.getLogger(FormPagosProveedor.class.getName()).log(Level.SEVERE, null, ex);
        }
